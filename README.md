...
- [jev-tree](https://github.com/lee-lou2/jev-tree) - Self-hosted knowledge service (Rust + SQLite) where a model walks a taxonomy tree to find and file Q&A. Abstains when unsure.
